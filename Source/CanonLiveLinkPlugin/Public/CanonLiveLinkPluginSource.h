...
class CANONLIVELINKPLUGIN_API FCanonLiveLinkPluginSource : public ILiveLinkSource, public FRunnable
{
public:

	FCanonLiveLinkPluginSource(FIPv4Endpoint Endpoint);

	virtual ~FCanonLiveLinkPluginSource();
