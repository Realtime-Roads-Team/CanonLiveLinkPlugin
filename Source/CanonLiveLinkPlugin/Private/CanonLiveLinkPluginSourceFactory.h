...
#include "CanonLiveLinkPluginSourceFactory.generated.h"

class SCanonLiveLinkPluginSourceEditor;

UCLASS()
class UCanonLiveLinkPluginSourceFactory : public ULiveLinkSourceFactory
{
public:
